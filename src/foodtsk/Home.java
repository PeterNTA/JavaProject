...
//    }
    ...
    public void loadListWarehouseIn() throws Exception{
        ...
        for(int i=0;i<list.size();i++){
            defaultTableModel.addRow(new Object[]{list.get(i).getProduct(),list.get(i).getName(),list.get(i).getQuantity(),list.get(i).getPrice(),list.get(i).getDate()});
        }
    }
...
//            }
         ...
         //  labels[i] = new JLabel(imageIcon);
            ...
            jPanelListFood.add(new JLabel(String.valueOf(list.get(i).getPrice()+".VND")),gbc );
             ...
             if(list.get(i).getQuantity() <= 0){
                 ...
                 button[i] = new JButton("Thêm");
                 button[i].setForeground(Color.black);
                 button[i].setBackground(new Color(255,255,204));
    ...
    JPanelHomeLayout.setHorizontalGroup(
        ...
        .addGroup(JPanelHomeLayout.createSequentialGroup()
            ...
            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        .addComponent(jPanelListFood, javax.swing.GroupLayout.DEFAULT_SIZE, 688, Short.MAX_VALUE)
    );
