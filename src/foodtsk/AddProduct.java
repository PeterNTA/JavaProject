                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(themmoncheck, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void kGradientPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kGradientPanel2MouseClicked
        // TODO add your handling code here:
                ...
                if(nhapkhocheck.isSelected()){
                        ...
                        int temp = Integer.parseInt(tfid.getText());
                        ProductDao pd = new ProductDao();
                        if (jTextFieldQuantity.getText().equals("")) {
                              JOptionPane.showMessageDialog(jPanel1, "không được bỏ trống số lượng");
                          }
                        else {
                            if (tfid.getText().equals("")) {
                                JOptionPane.showMessageDialog(jPanel1, "không được bỏ trống id");
                            } else {
                                if(jTextFieldPrice1.getText().equals("")){
                                    JOptionPane.showMessageDialog(jPanel1, "không được bỏ trống giá tiền");
                                }
                                else{
                                        ...
                                        int price = Integer.parseInt(jTextFieldPrice1.getText());
                ...
                if(themmoncheck.isSelected()){
                    ...
                    if (jTextFieldNameProduct.getText().equals("")) {
                    ...
                    }else if (jTextFieldPrice1.getText().equals("")) {
                        JOptionPane.showMessageDialog(jPanel1, "không được bỏ trống giá tiền");
                        ...
                        Integer price=Integer.parseInt(jTextFieldPrice1.getText()) ;
                        Integer quantity=Integer.parseInt(jTextFieldQuantity.getText());
