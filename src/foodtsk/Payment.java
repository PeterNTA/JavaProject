...
public class BillPrintable implements Printable {
  ...
  {    
      ...
      int result = NO_SUCH_PAGE;    
        ...
        try{
          ...
          String RecievedString="0 VNĐ";
            ...
            g2d.drawString("   Address Line 02 VIETNAM ",12,y);y+=yShift;
            ...
            g2d.drawString("         Ân, Dậu, Huy,Trường,Cương,Văn          ",10,y);y+=yShift;     
    ...
    private void initComponents() {
        ...
        btn_updatePayment1.setText("Tính");
